defmodule MakinaWeb.Router do
  ...
  scope "/api", MakinaWeb do
    ...
    post "/stacks/:stack_id/services/:service_id/redeploy", ApiController, :service_redeploy
  end
  ...
  scope "/", MakinaWeb do
    ...
    live_session :user, on_mount: [{MakinaWeb.UserAuth, :ensure_authenticated}] do
      live "/", Stacks.ListLive

      scope "/stacks", Stacks do
        live "/create", CreateLive
        live "/:id", ViewLive
        live "/:stack_id/services/create", CreateServiceLive
        live "/:stack_id/services/:service_id", ViewServiceLive
        live "/:stack_id/services/:service_id/logs", ViewServiceLive
      end
    end
  end
